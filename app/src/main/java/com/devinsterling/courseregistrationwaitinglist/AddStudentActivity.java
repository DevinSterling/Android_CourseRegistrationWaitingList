...
public class AddStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.add_student); // Set Title
        ...
        findViewById(R.id.btn_add_student).setOnClickListener(v -> {
            ...
            if (isVerified) {
                ...
                contentValues.put(DBContract.FeedEntry.COLUMN_STUDENT_COURSE_ID, courseId);
                ...
                try (SQLiteDatabase db = dbHelper.getReadableDatabase()) {
                    long result = db.insert(DBContract.FeedEntry.TABLE_STUDENTS, null, contentValues); // Insert new row

                    /* Check if the insert was successful */
                    if (result >= 1) {
                        Toast.makeText(this, R.string.success_add_student, Toast.LENGTH_SHORT).show();
                        returnActivity();
                    }
                    else {
                        Toast.makeText(this, R.string.fail_add_student, Toast.LENGTH_SHORT).show();
                    }
